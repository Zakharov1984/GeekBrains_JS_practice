...
elementsButton.forEach(function (elementButton) {
...
function showCategory(category) {
    let readyTemplate
    products[category].forEach(function (productElement) {
        readyTemplate = readyTemplate + getProductMarkup(productElement);
    });
    elementProducts.insertAdjacentHTML("afterbegin" ,readyTemplate);
}
