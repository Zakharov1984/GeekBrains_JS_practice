...
let sortingIMG = productsTaskFour.filter(function(image){    
...
let sortingPrice = productsTaskFour.sort(function(number1, number2) { // это задание подсмотрел( логику не понял )
